...
**Q**：What sample size does one need for MR-APSS?  
**A**: MR-APSS uses LDSC (LD Score regression) to estimate the parameters in the background model. Following the practice of LDSC, we recommend MR-APSS analysis of GWASs with more than ~5k samples.
