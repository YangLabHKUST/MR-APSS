...
**A**: MR-APSS uses LDSC (LD Score regression) to estimate the parameters in the background model. Following the practice of LDSC, we recommend MR-APSS for analyses of GWASs with more than ~5k samples.
