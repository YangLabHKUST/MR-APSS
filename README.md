...
# Reproduce[revising]
We provide the downlowad links for 34 GWAS summay datasets used in MR-APPSS paper which can be found [here](https://github.com/YangLabHKUST/MR-APSS_RealData_Code). The R code for processing datasets and implementing other compared MR methods as well as the results can be downloaded [here](https://github.com/YangLabHKUST/MRAPSS_RealData_Code)
# Reference
